...
function targetDate() {
	...
	var futureDate  = new Date(currentDate.getFullYear() + 0, 0, 08,23,59,59);
...
<body onload="targetDate()">
<h5>Countdown to the 12th Annual Alumni Meet</h5>
<div id="new" style="font-size:40px;font-family:verdana;"></div>
</body>
