...
<div style="position:relative;left:750px; width:236px; height:96px" >
<a href="#"><img src="images/061.png" /> </a>
</div>

</div>
<div id="text1" style="position:relative;top:70px ;height:1200px;width:1100px;background:transparent;left:83px;background-image:url('slide_text/images/back.png');padding-left:65px;padding-right:0px;padding-top:30px;margin-bottom:0px"> 
<?php
$objDB = new Database();	
$rs = $objDB->Getusers();
$i=1;
...
echo "<div>";
echo '<table align="left" cellspacing="5" border="0">';
$rs = $objDB->Getusers();
echo "<tr><td><strong>S. No.</strong></td><td><strong>First Name</strong></td><td><strong>Last Name</strong></td><td><strong>Department</strong></td><td><strong>Hall</strong></td><td><strong>Year</strong></td></tr>";
while($row=mysql_fetch_assoc($rs) ) {
				echo "<tr><td>".$i.".</td>";
			    echo "<td class style='width:200px;'>".$row["fname"]."</td><td class style='width:200px;'>".$row["lname"]."</td>";
				echo "<td class style='width:230px;'>".$row["dept"]."</td><td>".$row["hall"]."</td><td>".$row["year"]."</td>";
				echo "</tr>";
				$i++;
				}
}
...
<div id="footer" style="position:relative;float:bottom;z-index:1000;left:00px;top:70px">
	<font color="black"><p><b><center>&copy; Office of Alumni Affairs & International Relations, IIT Kharagpur</b></p></center></font>
</div> 
